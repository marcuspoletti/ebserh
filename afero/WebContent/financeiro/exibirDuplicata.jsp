...
<table border="0" width="100%">
   <tr>
      ...
      <td><select  disabled="disabled" name="idLoja" onchange="recarregar('<%=acao%>');" required="true">
  ...
  <tr>
      ...
      <td><select disabled="disabled" name="idColaborador" onchange="recarregar('<%=acao%>');">
          <option value='0'>Selecione...</option>
    ...
    <tr>
      ...
      <td><select disabled="disabled" name="idDuplicataPai" onchange="recarregar('<%=acao%>');">
          <option value='0'>Selecione...</option>
  ...
  <tr>
      ...
      <td><select disabled="disabled" name="idConta" onchange="recarregar('<%=acao%>');" style="width: 172px">
          <option value='0'>Selecione...</option>
    ...
    <tr>
      ...
      <td><select disabled="disabled" name="idPlanoConta" onchange="recarregar('<%=acao%>');" style="width: 172px">
          <option value='0'>Selecione...</option>
      ...
      <td><select disabled="disabled" name="idCentroCusto" onchange="recarregar('<%=acao%>');" style="width: 172px">
          <option value='0'>Selecione...</option>
  ...
  <tr>
      ...
      <td><select disabled="disabled" name="idTipoDocumento" onchange="recarregar('<%=acao%>');">
          <option value='0'>Selecione...</option>
   ...
   <td>
	     <input type="text" disabled="disabled" name="dtEmissao" size="15" <%if (dtEmissao != null) { %>value="<%=dtEmissao%>"<%} %> onblur="chkData(this,'dd/MM/yyyy')" maxlength="10" class="inputs">
  ...
  <tr>
    ...
    <td><input disabled="disabled" type="text" name="nrTitulo" value="<%=nrTitulo%>"  size="40" maxlength="40"></td>
  </tr>
   <tr>
    <th class="label">Número Documento</th>
    <td><input disabled="disabled" type="text" name="nrDoc" <%if (nrDoc != null) { %>value="<%=nrDoc%>"<% }%>  size="40" maxlength="40"></td>
  </tr>
    <tr>
    <th class="label">Número Série</th>
    <td><input disabled="disabled" type="text" name="nrSerie" <%if (nrSerie != null) { %>value="<%=nrSerie%>"<% }%>  size="40" maxlength="40"></td>
  </tr>

    <tr>
      <th class="label">Histórico</th>
      <td><textarea disabled="disabled" name="historico" cols="60" rows="5" ><%=historico%></textarea></td>
  </tr>
  <tr>
    <th class="label">Data Vencimento*</th>
   <td>
	     <input disabled="disabled" type="text" name="dtVenc" size="15" <%if (dtVenc != null) { %>value="<%=dtVenc%>" <%} %>onblur="chkData(this,'dd/MM/yyyy')" maxlength="10" class="inputs">
  ...
  <tr>  
    ...
    <td><input disabled="disabled" type="text" name="valor" value="<%=Utilitaria.formatarNumero(valor,2).toString()%>"  onkeyup="FormataValor(this,event)" size="40" maxlength="40"></td>
  </tr>
  <tr>  
    <th class="label">Taxa de Multa</th>
    <td><input disabled="disabled" type="text" name="txMulta" value="<%=Utilitaria.formatarNumero(txMulta,2).toString()%>"  onkeyup="FormataValor(this,event)" size="40" maxlength="40"></td>
  </tr>
  <tr>  
    <th class="label">Taxa de Juros</th>
    <td><input disabled="disabled" type="text" name="txJuros" value="<%=Utilitaria.formatarNumero(txJuros,2).toString()%>"  onkeyup="FormataValor(this,event)" size="40" maxlength="40"></td>
  </tr>
    <tr>
  ...
  <tr>
    <th class="label">Crédito / Débito</th>
      <td disabled="disabled" class="label_radio"><input type="radio" class="radio" name="dc" value="C" <%= (dc.equals("C")? "checked": "") %>>Crédito
  ...
  <tr>
    <th class="label">Tipo de Lançamento</th>
      <td class="label_radio"><input disabled="disabled" type="radio" class="radio" name="tipoLancamento" value="M" <%= (tipoLancamento.equals("M")? "checked": "") %>>Manual
    ...
    <th class="label">Tipo de Juros</th>
      <td class="label_radio"><input disabled="disabled" type="radio" class="radio" name="tipoJuros" value="M" <%= (tipoJuros.equals("M")? "checked": "") %>>Mensalmente
      <input type="radio" disabled="disabled" class="radio" name="tipoJuros" value="D" <%= (tipoJuros.equals("D")? "checked": "") %>>Diariamente</td>
  </tr>
  <tr>
    <th class="label">Gerar Boleto</th>
      <td class="label_radio"><input disabled="disabled" type="radio" class="radio" name="geraBoleto" value="S" <%= (geraBoleto.equals("S")? "checked": "") %>>Sim
      <input disabled="disabled" type="radio" class="radio" name="geraBoleto" value="N" <%= (geraBoleto.equals("N")? "checked": "") %>>Não</td>
  </tr>
      <tr>  
    <th class="label">Código de Barras</th>
    <td><input disabled="disabled" type="text" name="cdBarra" <%if (cdBarra != null) { %>value="<%=cdBarra%>"<%} %> size="40" maxlength="40"></td>
  </tr>
  
  <tr>
      <th class="label">Forma de Pagamento</th>
      <td><select disabled="disabled" name="cdFormaPagto" onchange="recarregar('<%=acao%>');">
          <option value='0'>Selecione...</option>
  ...
  <tr>
    <th class="label">Status da Duplicata</th>
      <td class="label_radio"><input disabled="disabled" type="radio" class="radio" name="status" value="A" <%= (status.equals("A")? "checked": "") %>>Ativo
      <input disabled="disabled" type="radio" class="radio" name="status" value="I" <%= (status.equals("I")? "checked": "") %>>Cancelado
      <input disabled="disabled" type="radio" class="radio" name="status" value="DQ" <%= (status.equals("DQ")? "checked": "") %>>Quitado
      <input disabled="disabled" type="radio" class="radio" name="status" value="RP" <%= (status.equals("RP")? "checked": "") %>>Reparcelado</td>
  ...
  <tr>
   ...
   <td>
	     <input disabled="disabled" type="text" name="dtBaixa" size="15" <%if (dtBaixa != null) { %>value="<%=dtBaixa%>"<%} %> onblur="chkData(this,'dd/MM/yyyy')" maxlength="10" class="inputs">
  ...
  <tr>  
    ...
    <td><input disabled="disabled" type="text" name="nrBaixa" value="<%=nrBaixa%>" size="40" maxlength="40"></td>
  </tr>
  <tr>  
    <th class="label">Valor da Multa</th>
    <td><input disabled="disabled" type="text" name="vlMulta" value="<%=Utilitaria.formatarNumero(vlMulta,2).toString()%>"  onkeyup="FormataValor(this,event)" size="40" maxlength="40"></td>
  </tr>
  <tr>  
    <th class="label">Valor do Juros</th>
    <td><input disabled="disabled" type="text" name="vlJuros" value="<%=Utilitaria.formatarNumero(vlJuros,2).toString()%>"  onkeyup="FormataValor(this,event)" size="40" maxlength="40"></td>
  </tr>
    <tr>  
    <th class="label">Valor do Desconto</th>
    <td><input disabled="disabled" type="text" name="vlDesc" value="<%=Utilitaria.formatarNumero(vlDesc,2).toString()%>"onkeyup="FormataValor(this,event)" size="40" maxlength="40"></td>
  </tr>
      <tr>  
    <th class="label">Valor da Baixa</th>
    <td><input disabled="disabled" type="text" name="vlBaixa" value="<%=Utilitaria.formatarNumero(vlBaixa,2).toString()%>" onkeyup="FormataValor(this,event)" size="40" maxlength="40"></td>
  </tr>
      <tr>  
    <th class="label">Autenticação</th>
    <td><input disabled="disabled" type="text" name="autenticacao" <%if (autenticacao != null) { %>value="<%=autenticacao%>" <%} %>  size="40" maxlength="40"></td>
  </tr>
