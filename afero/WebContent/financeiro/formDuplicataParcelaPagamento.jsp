...
<script>
	...
	function recarregar(acao) {
		document.forms[0].action = 'formDuplicataParcelaPagamento.jsp?acao=' + acao;
		document.forms[0].submit();
	}

	function cancelar() {
		document.forms[0].action = 'formDuplicataParcelaPagamento.jsp';
		document.forms[0].submit();
	}
...
<body onload="document.all.idConta.focus();">
	<h1 class="cabecalho_pagina">Contas a Pagar - Lançar Pagamento em Conta</h1>
...
<tr>
	<td>
		<input class="button" type="button" value="Lançar Pagamento" onClick="javascript: salvar();" />
