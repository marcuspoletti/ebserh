...
<script>
	...
	function parcelar() {
		...
		document.forms[0].action = 'formDuplicataReceber.jsp?acao=inc';
		document.forms[0].submit();
	}
...
<%
	...
	if(request.getParameter("idTipoDocumento") != null){;
		...
		<table border="0" width="100%">
          ...
          <script>comboSelect(document.forms[0].idCentroCusto, '<%= idCentroCusto%>');</script>
			...
			<tr>
				...
				<td class="label_radio">
				   <input type="radio" class="radio" name="tipoLancamento" value="M" <%=(tipoLancamento.equals("M") ? "checked" : "")%>>Manual 
				   <input type="radio" class="radio" name="tipoLancamento" value="A" <%=(tipoLancamento.equals("A") ? "checked" : "")%>>Automático
			        </td>
			</tr>
			<tr>
