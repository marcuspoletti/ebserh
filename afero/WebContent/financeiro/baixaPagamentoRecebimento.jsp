...
function recarregar(acao) {
  document.forms[0].action='baixaPagamentoRecebimento.jsp?acao='+acao;
  document.forms[0].submit();
}
function cancelar() {
  document.forms[0].action="listarDuplicataReceber.jsp";
  document.forms[0].submit();
}
...
<h1 class="cabecalho_pagina">Baixa do Contas a Receber</h1>
<form method="post" action="listarDuplicataReceber?acao=<%=acao%>">
