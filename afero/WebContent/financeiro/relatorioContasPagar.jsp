...
*/
if(!numDoc.equalsIgnoreCase("0")){
     clausula += " AND d.nrDoc = "+Integer.parseInt(numDoc);	
}
//seleciona todos os registros do banco de dados
List list;
dao = new DuplicataParcelaDAO(conn);
clausula = clausula+" AND d.dc = 'D' AND dp.dtVenc BETWEEN '"+converte.DMYToYMDI(dataIni)+" 00:00:00' AND '"+converte.DMYToYMDI(dataFim)+" 23:59:59'";
list = dao.listarDuplicataParcela(clausula);

int cont = 0;
%>
<h1 class="cabecalho_pagina">Consulta Contas a Pagar</h1>
<body onload="document.forms[0].elements[0].focus();" >
<% if (mensagem != null) { %><div class="mensagem"><center><%= mensagem %></center></div><hr><% } %>
<form action="relatorioContasPagar.jsp">
...
<table colspan="2">
  <tr>
    <th class='label'>Credor / Fornecedor</th>
  ...
  <tr>
    ...
    name="status" value="A" 
    <%=(status.equals("A") ? "checked" : "")%>>A Pagar <input
...
<table border="0" width="100%">
    <tr>
      ...
      <th class="grid"><center>Credor / Fornecedor</center></th>
