...
<table border="0" width="100%">
    <tr>
      ...
      <th class="grid" width="2%">Gerar Nota</th> 
    </tr>
<%
int cont = 0;
int gridSize = 20;
      ...
      <%if(statusPagamento.equalsIgnoreCase("S")) {%>
       ...
       <%if((pedSaida.getStatus().equalsIgnoreCase("A"))){%>
       	<%if(statusPagamento.equalsIgnoreCase("S")) {%>
       		<td class = "grid" width="2%"><center>-</center></td>	
      	<%}else{ %>
       		<td class = "grid" width="2%"><a target="_blank" href="../notafiscal/gerarNotaFiscal.jsp?idPedidoSaida=<%=pedSaida.getIdPedidoSaida()%>"><img border="0"src="../images/calculadora.jpg"></a></img></td>
