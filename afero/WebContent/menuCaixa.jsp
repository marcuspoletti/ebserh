...
<body>
<%
  String usuarioCaixa = (String)session.getAttribute("Login");
  String ultimoAcesso = "";
%>
<table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	...
	<tr height="18">
		<th bgcolor="#000000" colspan="2" align="right" style="line-height: normal; color: #FFFFFF; font-style: normal; font-size: 9px; font-family: Verdana, Arial, Sans-Serif">&nbsp;<%="Usuário: "+usuarioCaixa%>&nbsp;-&nbsp;<%="Último acesso: "+ultimoAcesso%>&nbsp;</th>
	</tr>
	<tr>
...
<script language="javaScript">
	...
	with(milonic=new menuname("Main Menu")) {
		...
		aI("text= Nota Fiscal ;showmenu=id100015;");
	...
	with(milonic=new menuname("id100005")) {
	  style=menuStyle;
	  overflow="scroll";
	  aI("text=Orçamento Presencial;url=orcamento/formOrcamento.jsp;target=principal;status=Orçamento Presencial");
	  aI("text=Consultar Orçamento Pres.;url=orcamento/consultarOrcamento.jsp;target=principal;status=Consultar Orçamento Pres.");
	...
	with(milonic=new menuname("id100007")) {
	  style=menuStyle;
	  overflow="scroll";
	  aI("text=Pedido Presencial;url=comercial/formPedido.jsp;target=principal;status=Pedido Presencial");
	  aI("text=Pedido Rápido;url=comercialrapido/formPedido.jsp;target=principal;status=Pedido Rápido");
	  aI("text=Pedido Telefonista;url=comercialtelefonista/formPedido.jsp;target=principal;status=Pedido Telefonista");
	  aI("text=Consultar Pedido Rápido.;url=comercialrapido/consultarPedidoSaida.jsp;target=principal;status= Consultar Pedido Rápido");
	  aI("text=Consultar Pedido Presencial;url=comercial/consultarPedidoSaida.jsp;target=principal;status=Consultar Pedido Presencial");
	  aI("text=Consultar Pedido Telefonista;url=comercialtelefonista/consultarPedidoSaida.jsp;target=principal;status=Consultar Pedido Telefonista");
	}
	...
	with(milonic=new menuname("id100008")) {
	 ...
	 // aI("text=Produtos mais Vendidos;url=painel/maisVendidos.jsp;target=principal;status=Produtos mais Vendidos");
	  ...
	  aI("text=Painel de Itens do Pedido Rápido;url=painel/painelItensPedido.jsp;target=principal;status=Painel de Itens do Pedido Rápido");
