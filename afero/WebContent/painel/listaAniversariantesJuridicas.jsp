...
<script>
function recarregar() {
  document.forms[0].action='listaAniversariantesJuridicas.jsp';
...
clausula = " WHERE MONTH(ej.dtAbertura)="+dataMes+
           " AND e.status = 'A'";
//seleciona todos os registros do banco de dados
List list = dao.listarAniversariantesJuridica(clausula);
%>
<h1 class="cabecalho_pagina">Aniversariantes (Pessoas Jurídicas)</h1>
<form action="listaAniversariantesJuridicas.jsp" method="post">
...
for (Iterator it = list.iterator(); it.hasNext();) {
	...
	if(entidade.getTpInsc().equalsIgnoreCase("J")){
			...
			EntidadeEmail entidadeEmail = daoEntidadeEmail.procurarEntidadeEmailPadrao(entidadeJuridica.getCdEntidade());
