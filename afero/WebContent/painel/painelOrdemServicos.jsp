...
function recarregar() {
  document.forms[0].action='painelOrdemServicos.jsp';
  document.forms[0].submit();
}
</script>
<%
...
if (cdLoja == null) {
  ...
  if (dataIni == null) {
   dataIni = daoOrdemServico.dataAtualPedido();
  }
  if (dataFim == null) {
    dataFim = daoOrdemServico.dataAtualPedido();
  }
  
  String frameAberto = "?dataIni="+dataIni+"&dataFim="+dataFim+"&status=A&idLoja="+idLoja;
  String frameFechado = "?dataIni="+dataIni+"&dataFim="+dataFim+"&status=F&idLoja="+idLoja;
...
<div class="cabecalho_pagina">Painel de Ordem de Serviço</div>
<hr>
<form action="painelOrdemServicos.jsp">
...
<tr>
 <th class="grid" colspan="2">ORDEM DE SERVIÇO ABERTO</th>
</tr>
<tr>
 <td colspan="2">
  <iframe src="frameOrdemServico.jsp<%= frameAberto %>" src2="" name="frame_pedido" width="100%" height=200 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
<tr>
 <th class="grid" colspan="2">ORDEM DE SERVIÇO FECHADO</th> 
</tr>
<tr>
 <td colspan="2">
  <iframe src="frameOrdemServico.jsp<%= frameFechado %>" src2="" name="frame_pedido" width="100%" height=200 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
<tr>
 <th class="grid" colspan="2">ORDEM DE SERVIÇO CANCELADO</th> 
</tr>
<tr>
 <td colspan="2">
  <iframe src="frameOrdemServico.jsp<%= frameCancelado %>" src2="" name="frame_pedido" width="100%" height=200 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
</table>
<br><br>
