...
function recarregar() {
  document.forms[0].action='painelItensPedidoRapido.jsp';
  document.forms[0].submit();
}
</script>
<%
...
if (cdLoja == null) {
  ...
  String frameItensPedidoRapido = "?dataIni="+dataIni+"&dataFim="+dataFim+"&idLoja="+idLoja+"&idDivisao="+idDivisao;
  String continua = "";
%>
<%-- Início do Conteúdo da Página --%>
<div class="cabecalho_pagina">Painel de Itens dos Pedidos Rápido</div>
<hr>
<form action="painelItensPedidoRapido.jsp">
...
<tr>
 <th class="grid" colspan="2">Itens do Pedido Rápido</th>
</tr>
<tr>
 <td colspan="2">
  <iframe src="frameItensPedidoRapido.jsp<%=frameItensPedidoRapido%>" src2="" name="frame_pedido" width="100%" height=900 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
</table>
<br><br>
