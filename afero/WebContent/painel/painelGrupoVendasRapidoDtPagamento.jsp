...
function recarregar() {
  document.forms[0].action='painelGrupoVendasRapidoDtPagamento.jsp';
  document.forms[0].submit();
}
...
<div class="cabecalho_pagina">Painel de Vendas por Grupo (Ped.Rápido por Data de Pagamento) </div>
<hr>
<form action="painelGrupoVendasRapidoDtPagamento.jsp">
...
<table border="0" width="100%">
    <tr>
      <td class='grid'>Data Pag. Inicial 
...
<tr>
 <td colspan="2">
  <iframe src="frameVendasGruposRapidoDtPag.jsp<%=frame%>" src2="" name="frame_pedido" width="100%" height=200 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
<tr>
...
<tr>
 <td colspan="2">
  <iframe src="frameVendasGrupoCondicaoPagamentoRapidoDtPag.jsp<%=frame%>" src2="" name="frameCondPagto" width="100%" height=200 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
</table>
<br><br>
