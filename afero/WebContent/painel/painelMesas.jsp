...
if (cdLoja == null) {
  ...
  int idUsuario = daoUsuario.procurarLogin(usuario);
  ColaboradorDAO daoColaborador = new ColaboradorDAO(conn);
  Colaborador colaborador = daoColaborador.procurarColaboradorUsuario(idUsuario);
  ...
  String framePendente = "?dataIni="+dataIni+"&dataFim="+dataFim+"&status=P&idLoja="+idLoja+"&tipoPedido="+tipoPedido+"&statusPag="+statusPag+"&cdCondPagto="+Integer.parseInt(cdCondPagto)+"&idColaborador="+colaborador.getIdUsuario();
  String frameAtendido = "?dataIni="+dataIni+"&dataFim="+dataFim+"&status=A&idLoja="+idLoja+"&tipoPedido="+tipoPedido+"&statusPag="+statusPag+"&cdCondPagto="+Integer.parseInt(cdCondPagto)+"&idColaborador="+colaborador.getIdUsuario();
  String frameCancelado = "?dataIni="+dataIni+"&dataFim="+dataFim+"&status=C&idLoja="+idLoja+"&tipoPedido="+tipoPedido+"&statusPag="+statusPag+"&cdCondPagto="+Integer.parseInt(cdCondPagto)+"&idColaborador="+colaborador.getIdUsuario();
  String continua = "";
%>
<%-- Início do Conteúdo da Página --%>
<div class="cabecalho_pagina">Painel de Mesas</div>
<hr>
<form action="painelMesas.jsp">
...
<tr>
 <th class="grid" colspan="2">MESAS PENDENTE</th>
</tr>
<tr>
 <td colspan="2">
  <iframe src="frameMesas.jsp<%= framePendente %>" src2="" name="frame_pedido" width="100%" height=200 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
<tr>
 <th class="grid" colspan="2">MESAS ATENDIDAS</th> 
</tr>
<tr>
 <td colspan="2">
  <iframe src="frameMesas.jsp<%= frameAtendido %>" src2="" name="frame_pedido" width="100%" height=200 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
<tr>
 <th class="grid" colspan="2">MESAS CANCELADAS</th> 
</tr>
<tr>
 <td colspan="2">
  <iframe src="frameMesas.jsp<%= frameCancelado %>" src2="" name="frame_pedido" width="100%" height=200 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
</table>
<br><br>
