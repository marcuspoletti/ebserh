...
clausula = " AND ps.dtPed BETWEEN '"+converte.DMYToYMDI(dataIni)+" 00:00:00' AND '"+converte.DMYToYMDI(dataFim)+" 23:59:59'"; 
    
if(!idLoja.equalsIgnoreCase("0")){
	clausula = clausula + " AND p.idDivisao = "+Integer.parseInt(idDivisao);
}
...
list = dao.listarPedidoItensRapido(clausula);
