...
if(tipoPedido==null)tipoPedido="R";
...
if(!cdCondPagto.equalsIgnoreCase("0")){
   clausula = " WHERE  ps.statusPag='"+statusPag+"' AND ps.tipoPedido ='"+tipoPedido+"' AND ps.status = '"+status+"' AND ps.dtPed BETWEEN '"+converte.DMYToYMDI(dataIni)+" 00:00:00' AND '"+converte.DMYToYMDI(dataFim)+" 23:59:59' AND ps.cdCondPagto = "+Integer.parseInt(cdCondPagto);	 
}else{
   clausula = " WHERE  ps.statusPag='"+statusPag+"' AND ps.tipoPedido ='"+tipoPedido+"' AND ps.status = '"+status+"' AND ps.dtPed BETWEEN '"+converte.DMYToYMDI(dataIni)+" 00:00:00' AND '"+converte.DMYToYMDI(dataFim)+" 23:59:59'";
}
