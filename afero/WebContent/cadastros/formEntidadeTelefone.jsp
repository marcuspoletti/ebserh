...
function cancelar() {
  document.forms[0].action="formEntidadeTelefone.jsp";
  document.forms[0].submit();
}

function voltar(cdEntidade) {
  document.forms[0].action = 'listarEntidadeTelefone.jsp?acao=voltar&cdEntidade='+cdEntidade;
	document.forms[0].submit();
}  
...
<%
//variáveis capturadas da página listarEntidadeTelefone.jsp
...
<form method="post" action="listarEntidadeTelefone.jsp?cdEntidade=<%=cdEntidade%>&acao=<%=acao%>&idEntidadeTelefone=<%=idEntidadeTelefone%>&acaoAnterior=<%=acaoAnterior%>">
