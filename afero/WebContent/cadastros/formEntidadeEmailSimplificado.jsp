...
function cancelar() {
  document.forms[0].action="formEntidadeEmailSimplificado.jsp";
  document.forms[0].submit();
}

function voltar(cdEntidade) {
  document.forms[0].action = 'listarEntidadeEmailSimplificado.jsp?acao=voltar&cdEntidade='+cdEntidade;
	document.forms[0].submit();
}  
...
<%
//variáveis capturadas da página listarEntidadeEmailSimplificado.jsp
...
<form method="post" action="listarEntidadeEmailSimplificado.jsp?cdEntidade=<%=cdEntidade%>&acao=<%=acao%>&idEntidadeEmail=<%=idEntidadeEmail%>&acaoAnterior=<%=acaoAnterior%>">
