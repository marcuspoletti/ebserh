...
function confirmaExcluir(cont, cd, id) {  
  if (confirm("Deseja mesmo apagar o registro [" + cont + "]?")) {  
       location.href = 'listarEntidadeDependente.jsp?acao=exc&cdEntidade=' + cd + '&idEntidadeDependente=' + id;   
  }  
}  
</script>
...
|<a class="button" href="formEntidadeDependente.jsp?cdEntidade=<%=cdEntidade %>&acao=inc">Novo Dependente</a>|&nbsp;&nbsp;&nbsp;
...
%>
    <tr>
      ...
      <td class = "grid"><center><a href="formEntidadeDependente.jsp?idEntidadeDependente=<%=entidadeDependente.getIdEntidadeDependente()%>&acao=atu">
