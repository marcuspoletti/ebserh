...
function confirmaExcluir(cont, cd, id) {  
  if (confirm("Deseja mesmo apagar o registro [" + cont + "]?")) {  
       location.href = 'listarEntidadeTelefoneSimplificado.jsp?acao=exc&cdEntidade=' + cd + '&idEntidadeTelefone=' + id;   
  }  
}  
</script>
...
|<a class="button" href="formEntidadeTelefoneSimplificado.jsp?cdEntidade=<%=cdEntidade %>&acao=inc">Novo Telefone</a>|&nbsp;&nbsp;&nbsp;
...
%>
    <tr>
      ...
      <td class = "grid"><center><a href="formEntidadeTelefoneSimplificado.jsp?idEntidadeTelefone=<%=entidadeTelefone.getIdEntidadeTelefone()%>&&acao=atu">
