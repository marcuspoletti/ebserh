...
function confirmaExcluir(cont, cd, id) {  
  if (confirm("Deseja mesmo apagar o registro [" + cont + "]?")) {  
       location.href = 'listarEntidadeEmailSimplificado.jsp?acao=exc&cdEntidade=' + cd + '&idEntidadeEmail=' + id;   
  }  
}  
</script>
...
|<a class="button" href="formEntidadeEmailSimplificado.jsp?cdEntidade=<%=cdEntidade %>&acao=inc">Novo Email</a>|&nbsp;&nbsp;&nbsp;
...
%>
    <tr>
      ...
      <td class = "grid"><center><a href="formEntidadeEmailSimplificado.jsp?idEntidadeEmail=<%=entidadeEmail.getIdEntidadeEmail()%>&&acao=atu">
