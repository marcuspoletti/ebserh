...
function cancelar() {
  document.forms[0].action="formEntidadeDependenteSimplificado.jsp";
  document.forms[0].submit();
}

function voltar(cdEntidade) {
  document.forms[0].action = 'listarEntidadeDependenteSimplificado.jsp?acao=voltar&cdEntidade='+cdEntidade;
	document.forms[0].submit();
}  
...
<%
//variáveis capturadas da página listarEntidadeDependenteSimplificado.jsp
...
<form method="post" action="listarEntidadeDependenteSimplificado.jsp?cdEntidade=<%=cdEntidade%>&acao=<%=acao%>&idEntidadeDependente=<%=idEntidadeDependente%>&acaoAnterior=<%=acaoAnterior%>">
