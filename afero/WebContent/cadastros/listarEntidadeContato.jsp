...
function confirmaExcluir(cont, cd, id) {  
  if (confirm("Deseja mesmo apagar o registro [" + cont + "]?")) {  
       location.href = 'listarEntidadeContato.jsp?acao=exc&cdEntidade=' + cd + '&idEntidadeContato=' + id;   
  }  
}  
</script>
...
|<a class="button" href="formEntidadeContato.jsp?cdEntidade=<%=cdEntidade %>&acao=inc">Novo Contato</a>|&nbsp;&nbsp;&nbsp;
...
%>
    <tr>
      ...
      <td class = "grid"><center><a href="formEntidadeContato.jsp?idEntidadeContato=<%=entidadeContato.getIdEntidadeContato()%>&acao=atu">
