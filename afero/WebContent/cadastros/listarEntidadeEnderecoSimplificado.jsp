...
function confirmaExcluir(cont, cd, id) {  
  if (confirm("Deseja mesmo apagar o registro [" + cont + "]?")) {  
       location.href = 'listarEntidadeEnderecoSimplificado.jsp?acao=exc&cdEntidade=' + cd + '&idEntidadeEndereco=' + id;   
  }  
}  
</script>
...
|<a class="button" href="formEntidadeEnderecoSimplificado.jsp?cdEntidade=<%=cdEntidade %>&acao=inc">Novo Endereço</a>|&nbsp;&nbsp;&nbsp;
...
%>
    <tr>
      ...
      <td class = "grid"><center><a href="formEntidadeEnderecoSimplificado.jsp?idEntidadeEndereco=<%=entidadeEndereco.getIdEntidadeEndereco()%>&&acao=atu">
