...
String pesCampo1 = request.getParameter("campo1");
String pesCampo2 = request.getParameter("campo2");
String pesCampo3 = request.getParameter("campo3");
String pesCampo4 = request.getParameter("campo4");
...
//String cdLojaPesquisa = request.getParameter("idLojaPesquisa");
...
//	} catch (NumberFormatException nfe) {
 ...
 if(dsPesquisaObjeto != null){
	 clausula += " AND WHERE dsListaObjeto LIKE '"+dsPesquisaObjeto+"%'";
 }
 if (!status.isEmpty()) {
    if (clausula.isEmpty()) {
...
%>
<h1 class="cabecalho_pagina">Lista de Objetos</h1>
