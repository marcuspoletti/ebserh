...
if (idColaborador == null) idColaborador= (String)session.getAttribute("idColaborador");
...
if (idPedidoSaida == null || idPedidoSaida.equals("0")) {
	...
	pedidoSaida.setIdVendedor(daoPedidoSaida.getIdVendedor(Integer.parseInt(idPedidoSaida)));
	...
	if (idVendedor == null) {
		idVendedor = "".valueOf(pedidoSaida.getIdVendedor());
	} else {
	...
	daoPedidoSaidaAtu.atualizarIdVendedor(pedidoSaida.getIdVendedor(), pedidoSaida.getIdPedidoSaida());
}
%>
