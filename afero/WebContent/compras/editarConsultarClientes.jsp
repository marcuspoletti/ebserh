...
if (idPedidoEntrada == null) idPedidoEntrada = "0";
...
%>
    <tr>
      ...
      <td class = "grid"><center><a class="link" target="principal" href="editarFormCompras.jsp?cdEntidade=<%=cdEntidade%>&idPedidoEntrada=<%=idPedidoEntrada%>&acao=<%="atu"%>&dsEntidade=<%=nomeEntidade%>&idLoja=<%=idLoja%>&idColaborador=<%=idColaborador%>&nrDoc=<%=nrDoc%>"onclick="javascript:window.close()"><%=nomeEntidade%></a></center></td>
