...
if (idPedidoEntrada == null || idPedidoEntrada.equals("0")){
	...
	if(acao.equalsIgnoreCase("atu")){
		daoPedidoEntrada.atualizarFornecedor(Integer.parseInt(idPedidoEntrada), Integer.parseInt(cdEntidade), usuario);
...
<h1 class="cabecalho_pagina">Editar Compras</h1>
...
<table border="0" width="100%">
   <tr>
    ...
    <td><input type="text" name="nrDoc" <%if (nrDoc != null) { %>value="<%=nrDoc%>"<% }%>  size="5" maxlength="5"></td>
  </tr>
  <tr>
    ...
    <tr>
      <th class="label" style="height: 22px">Fornecedor / Distribuidor</th>
            <td style="height: 15px"><input disabled type="text" name="dsEntidade" <%if (dsEntidade != null) { %>value="<%=dsEntidade%>"<% }%>  size="60" maxlength="60"><a  href="editarConsultarClientes.jsp?acao=<%=acao%>&idPedidoEntrada=<%=idPedidoEntrada%>&idLoja=<%=idLoja%>&idColaborador=<%=idColaborador%>&nrDoc=<%=nrDoc%>"><img border = "0" src="../images/pesquisa.gif"></a></td>
