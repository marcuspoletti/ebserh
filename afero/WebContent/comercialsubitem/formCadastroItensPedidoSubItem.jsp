...
if(tipoPedido == null)tipoPedido="S";
...
<h1 class="cabecalho_pagina">Cadastro de Pedido Itens</h1>
<hr>
...
<tr>
 <td><%@include file="../WEB-INF/jspf/grids/itensPedidoSubItem.jspf"%>
 </td>
 </tr>
 <tr>
...
<tr>
 <td>
  <iframe src="itensPedidoItemSubItem.jsp?idPedidoSaida=<%=idPedidoSaida%>" src2="" name="itensPedidoItemSubItem" width="100%" height="100%" scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
 </tr>
</table>
