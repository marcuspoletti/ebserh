...
%>
    <tr>
      ...
      <td class = "grid"><center><a target="editar" href="editarFormPedido.jsp?idPedidoSaida=<%=idPedidoSaida%>&cdEntidade=<%=cdEntidade%>&acao=<%=acao%>&dsEntidade=<%=nomeEntidade%>&idLoja=<%=idLoja%>&idEntrega=<%=idEntrega%>&idColaborador=<%=idColaborador%>"onclick="javascript:window.close()"><%=nomeEntidade%></a></center></td>
