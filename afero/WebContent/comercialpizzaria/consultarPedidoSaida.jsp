...
clausula = clausula+" AND ps.tipoPedido='PZ' AND ps.operacao='S' AND ps.idLoja = "+Integer.parseInt(idLojaUsuario);
...
<table border="0" width="100%">
    <tr>
      ...
      <%--<th class="grid" width="2%"><center>Ordem de Prod.</center></th> --%>
      ...
      <th class="grid" width="2%">Ped. Ant.</th>
...
%>
   ...
   <tr>
      ...
      <td class = "grid" width="5%"><center><%=converte.dateToStr(pedidoSaida.getDtPed(),"dd/MM/yyyy HH:mm:ss")%></center></td>
      <%--<td class = "grid" width="2%"><center><a target="_blank" href="ordemProd.jsp?idPedidoSaida=<%=pedSaida.getIdPedidoSaida()%>"><img border = "0" src="../images/imprimir.gif"></a></center></td> --%>
      <td class = "grid" width="2%"><center><a href="javaScript:void(window.open('impressaoBobinaC.jsp?idPedidoSaida=<%=pedSaida.getIdPedidoSaida()%>','endeavour','width=420,height=420,scrollbars=yes'));"><img border = "0" src="../images/imprimir.gif"></a></center></td>
      ...
      <%}else{ %>
      	<td class = "grid" width="2%"><center>-</center></td>
      <%}%>
      <td class = "grid" width="2%"><center><a target="_blank" href="listarPedidosVendidos.jsp?cdEntidade=<%=pedSaida.getCdEntidade()%>"><img border = "0" src="../images/ficha.gif"></a></center></td>
