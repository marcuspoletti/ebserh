...
<h1 class="cabecalho_pagina">Pedido Pizzaria</h1>
   ...
   --%>
    <tr>
      <th class="label" style="height: 22px">Cliente*</th>
          <td style="height: 15px"><input disabled type="text" name="dsEntidade" <%if (dsEntidade != null) { %>value="<%=dsEntidade%>"<% }%>  size="60" maxlength="60"> <a href="consultarClientes.jsp?acao=<%=acao%>&idPedidoSaida=<%=idPedidoSaida%>&idLoja=<%=idLoja%>&idEntrega=<%=idEntrega%>&idColaborador=<%=idColaborador%>&cdCondPagto=<%=cdCondPagto%>"><img border = "0" src="../images/pesquisa.gif"></a></td>
  </tr>
    <tr>
