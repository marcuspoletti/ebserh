...
<script type="text/javascript">
	...
	function processar() {
		...
		loadXMLDoc(
				"formGerarArquivoEmitenteProcessar.jsp?arquivo=" + arquivo,
				function() {
...
<body onload="document.forms[0].elements[2].focus();">
	...
	<form name="formGerarArquivoEmitente"
		action="formGerarArquivoEmitente.jsp" method="post">
		<h1 class="cabecalho">Gerar Arquivo Emitente</h1>
			...
			<tr>
				...
				<td><input class="button"
					type="button" value="Processar" onclick="javascript:processar();" />
 					<input class="button" type="button" value="Voltar" onclick="location.href='../cadastros/listarLoja.jsp';" />
				</td>
			</tr>
		</table>
		<div id="retorno"></div>
