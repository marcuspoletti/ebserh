...
<body>
<%
  String usuarioBal = (String)session.getAttribute("Login");
  String ultimoAcesso = "";
%>
<table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	...
	<tr height="18">
		<th bgcolor="#000000" colspan="2" align="right" style="line-height: normal; color: #FFFFFF; font-style: normal; font-size: 9px; font-family: Verdana, Arial, Sans-Serif">&nbsp;<%="Usuário: "+usuarioBal%>&nbsp;-&nbsp;<%="Último acesso: "+ultimoAcesso%>&nbsp;</th>
	</tr>
	<tr>
...
<script language=javascript>
	...
	with(milonic=new menuname("id100007")) {
	  ...
	  aI("text=Consultar Pedido Rápido.;url=comercialrapido/consultarPedidoSaidaSemPago.jsp;target=principal;status= Consultar Pedido Rápido");
	  aI("text=Consultar Pedido Presencial;url=comercial/consultarPedidoSaidaSemPago.jsp;target=principal;status=Consultar Pedido Presencial");
	  aI("text=Consultar Pedido Telefonista;url=comercialtelefonista/consultarPedidoSaidaSemPago.jsp;target=principal;status=Consultar Pedido Telefonista");
	}
