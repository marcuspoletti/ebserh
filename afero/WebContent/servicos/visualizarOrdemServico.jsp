...
function calcula() {
	var trocaP = /\./g; 
	var valorServico = document.getElementById('vlServ').value.replace(".",",",",");
	var desconto = document.getElementById('vlDesc').value.replace(".",",",",");
	
	var calcularDesconco = parseFloat((valorServico*desconto)/100);
	var total = parseFloat(valorServico - calcularDesconco);
	//var valorFrete = parseFloat(document.getElementById('vlFrete').value);//.replace(",","."));
	//var totalOrdem = parseFloat(total) + parseFloat(valorFrete);
	var formatarCasas = total;//.toFixed(2);
	//var formatarTotal = formatarCasas.toString().replace(trocaP,",");
	document.getElementById('vlTotal').value = formatarCasas;	   
...
%>
	...
	<tr>
		<th class="label">Data de Ordem Serviço</th>
	...
	<tr>
		<th class="label">Hora de Entrada</th>
	...
	<tr>
		<th class="label">Data de Entrega Realizada</th>
	...
	<tr>
		<th class="label">Condição de Pagamento</th>
	...
	<tr>
		...
		<td><input type="text"  id="vlServ" name="vlServ" value="<%=Utilitaria.formatarNumero(vlServ, 2) %>" onkeyup="FormataValor(this,event)" size="40" maxlength="40" /></td>
	</tr>
	<tr>
	...
	<tr>
		<th class="label">Custo de Deslocamento(R$)</th>
		<td><input type="text"  id="vlFrete" name="vlFrete" value="<%=Utilitaria.formatarNumero(vlFrete, 2) %>" onkeyup="FormataValor(this,event)" size="40" maxlength="40" /></td>
	</tr>
	<tr>
