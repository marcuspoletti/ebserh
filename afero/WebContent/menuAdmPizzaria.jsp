		...
		<table border="0" width="100%" height="80" cellspacing="0" cellpadding="0" 
		   background="images/barra1280.jpg">
			<tr>
				...
				<td bgcolor="#FFFFFF" align="center" ><img src="images/logomarca.jpg" style="width: 96px; height: 70px"></td>
			</tr>
			<tr>
				<td></td>
...
<script language=javascript>
	...
	with(milonic=new menuname("Main Menu")) {
		...
		aI("text= Comandas ;showmenu=id100007;");
	...
	with(milonic=new menuname("id100004")) {
	 ...
	 // aI("text=Atualizar Estoque;url=cadastros/atualizarEstoque.jsp;target=principal;status=Atualizar Estoque");
	  ...
	  aI("text=Lista de Estoque Inventário;url=estoque/listaProdutoEstoqueInventario.jsp;target=principal;status=Lista de Estoque Inventário");
	...
	with(milonic=new menuname("id100007")) {
	  ...
	  //aI("text=Pedido;url=comercial/formPedido.jsp;target=principal;status=Ped. Pizzaria");
	  aI("text=Produtos (Comandas);url=comercialpizzaria/cadastros/listarProduto.jsp;target=principal;status=Produto (Comandas)");
	  aI("text=Entidades Física (Comandas);url=comercialpizzaria/cadastros/listarEntidadeFisicaSimplificado.jsp;target=principal;status=Cadastrar entidades física");
	...
	with(milonic=new menuname("id100008")) {
	  ...
	  <%--aI("text=Painel de Vendas por Grupo;url=painel/painelGrupoVendas.jsp;target=principal;status=Painel de Vendas por Grupo");--%>
