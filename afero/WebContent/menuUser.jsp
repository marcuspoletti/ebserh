...
<%
  String usuarioUser = (String)session.getAttribute("Login");
  String ultimoAcesso = "";
%>
<table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	...
	<tr height="18">
		<th bgcolor="#000000" colspan="2" align="right" style="line-height: normal; color: #FFFFFF; font-style: normal; font-size: 9px; font-family: Verdana, Arial, Sans-Serif">&nbsp;<%="Usuário: "+usuarioUser%>&nbsp;-&nbsp;<%="Último acesso: "+ultimoAcesso%>&nbsp;</th>
	</tr>
	<tr>
...
<script language=javascript>
	...
	with(milonic=new menuname("id100002")) {
		style=menuStyle;
		overflow="scroll";
		aI("text=Entidades Física;url=cadastros/listarEntidadeFisicaSimplificado.jsp;target=principal;status=Cadastrar entidades física");
		aI("text=Entidades Jurídica;url=cadastros/listarEntidadeJuridicaSimplificado.jsp;target=principal;status=Cadastrar entidades jurídica");
	...
	with(milonic=new menuname("id100005")) {
	  style=menuStyle;
	  overflow="scroll";
	  aI("text=Orçamento;url=orcamento/formOrcamento.jsp;target=principal;status=Orçamento");
