...
public class VendaAssistida extends HttpServlet {
    ...
    //TODO Neste método, basta ajustar o SQL
    private String listaPedidos(String id_empresa, Connection con, boolean in_bootstrap,String data_ini,String data_fim, boolean nova_versao)throws Exception{
        ...
        try {
            PreparedStatement ps = conn.prepareStatement(
                ...
                //TODO Ajuste o SQL para trazer os pedidos para emissão de NFC-e, lembrando que data_ini e data_fim pode vir preenchido do PDV
    ...
    //TODO Método para gerar o arquivo com os dados do pedido, relação dos produtos e informação do financeiro (opcional)
    private String pedido(String id_pedido, Connection con)throws Exception{
        ...
        if (rsPedido.next()){
            ...
            //TODO Fazer teste de CPF/CNPJ válido para enviar para a NFC-e. Caso não seja válido, será considerado como consumidor final.
