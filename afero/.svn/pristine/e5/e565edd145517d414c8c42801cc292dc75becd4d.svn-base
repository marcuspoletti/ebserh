...
function recarregar() {
  document.forms[0].action='painelGrupoVendasTelefonistaDtPagamento.jsp';
  document.forms[0].submit();
}
...
if (cdLoja == null) {
  ...
  String frame = "?dataIni="+dataIni+"&dataFim="+dataFim+"&status=P&idLoja="+idLoja+"&horaIni="+horaIni+"&horaFim="+horaFim+"&idVendedor="+idVendedor;
%>
<script>
function atualizar() {
  document.forms[0].submit();
...
<div class="cabecalho_pagina">Painel de Vendas por Grupo (Ped. Telefonista por Data de Pagamento)</div>
<hr>
<form action="painelGrupoVendasTelefonistaDtPagamento.jsp">
...
<tr>
 <td colspan="2">
  <iframe src="frameVendasGruposTelefonistaDtPag.jsp<%=frame%>" src2="" name="frame_pedido" width="100%" height=200 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
<tr>
...
<tr>
 <td colspan="2">
  <iframe src="frameVendasGrupoCondicaoPagamentoTelefonistaDtPag.jsp<%=frame%>" src2="" name="frameCondPagto" width="100%" height=200 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
</table>
<br><br>
