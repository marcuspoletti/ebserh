...
function recarregar() {
  document.forms[0].action='painelGrupoVendasPizzaria.jsp';
  document.forms[0].submit();
}
...
<div class="cabecalho_pagina">Painel de Vendas por Grupo Pizzaria</div>
<hr>
<form action="painelGrupoVendasPizzaria.jsp">
...
<tr>
 <td colspan="2">
  <iframe src="frameVendasGruposPizzaria.jsp<%=frame%>" src2="" name="frame_pedido" width="100%" height=200 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
<tr>
...
<tr>
 <td colspan="2">
  <iframe src="frameVendasGrupoCondicaoPagamentoPizzaria.jsp<%=frame%>" src2="" name="frameCondPagto" width="100%" height=200 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
</table>
<br><br>
