...
<script>
	...
	function recarregar(acao) {
		document.forms[0].action = 'formDuplicataParcelaReceber.jsp?acao=' + acao;
		document.forms[0].submit();
	}

	function cancelar() {
		document.forms[0].action = 'formDuplicataParcelaReceber.jsp';
		document.forms[0].submit();
	}
...
<body onload="document.all.historico.focus();">
	<h1 class="cabecalho_pagina">Contas a Receber - Parcela</h1>
