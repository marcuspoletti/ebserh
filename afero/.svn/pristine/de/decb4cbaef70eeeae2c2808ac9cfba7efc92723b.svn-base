...
function recarregar() {
  document.forms[0].action='painelItensPedido.jsp';
  document.forms[0].submit();
}
</script>
<%
...
<hr>
<form action="painelItensPedido.jsp">
...
<tr>
 <th class="grid" colspan="2">Itens do Pedido</th>
</tr>
<tr>
 <td colspan="2">
  <iframe src="frameItensPedido.jsp<%=frameItensPedido%>" src2="" name="frame_pedido" width="100%" height=900 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
</table>
<br><br>
