...
<div class="cabecalho_pagina">Painel de Compras</div>
<hr>
<form action="painelCompras.jsp">
...
<tr>
 <th class="grid" colspan="2">COMPRAS PENDENTE</th>
</tr>
<tr>
 <td colspan="2">
  <iframe src="frameCompra.jsp<%= framePendente %>" src2="" name="frame_pedido" width="100%" height=200 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
<tr>
 <th class="grid" colspan="2">COMPRAS ATENDIDO</th> 
</tr>
<tr>
 <td colspan="2">
  <iframe src="frameCompra.jsp<%= frameAtendido %>" src2="" name="frame_pedido" width="100%" height=200 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
<tr>
 <th class="grid" colspan="2">COMPRAS CANCELADO</th> 
</tr>
<tr>
 <td colspan="2">
  <iframe src="frameCompra.jsp<%= frameCancelado %>" src2="" name="frame_pedido" width="100%" height=200 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
</table>
<br><br>
