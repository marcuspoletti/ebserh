...
function recarregar() {
  document.forms[0].action='painelPedidoBalcao.jsp';
  document.forms[0].submit();
}
</script>
<%
...
if (cdLoja == null) {
  ...
  String frameFaturado = "?dataIni="+dataIni+"&dataFim="+dataFim+"&status=F&idLoja="+idLoja;
  String continua = "";
%>
<script>
function atualizar() {
...
<div class="cabecalho_pagina">Painel de Pedidos Balcão</div>
<hr>
<form action="painelPedidoBalcao.jsp">
...
<tr>
 <td colspan="2">
  <iframe src="framePedidoBalcao.jsp<%= framePendente %>" src2="" name="frame_pedido" width="100%" height=200 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
<tr>
...
<tr>
 <td colspan="2">
  <iframe src="framePedidoBalcao.jsp<%= frameAtendido %>" src2="" name="frame_pedido" width="100%" height=200 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
<tr>
...
<tr>
 <td colspan="2">
  <iframe src="framePedidoBalcao.jsp<%= frameCancelado %>" src2="" name="frame_pedido" width="100%" height=200 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
<tr>
 <th class="grid" colspan="2">PEDIDO FATURADO</th> 
</tr>
<tr>
 <td colspan="2">
  <iframe src="framePedido.jsp<%= frameFaturado %>" src2="" name="frame_pedido" width="100%" height=200 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
</table>
<br><br>
