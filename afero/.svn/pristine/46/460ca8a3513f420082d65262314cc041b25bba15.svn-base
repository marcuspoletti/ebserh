...
<% 
	 ...
	 if(isdMesa != 0){
		 daoMesa.atualizarStatus(isdMesa, "A"); 
	 }
...
%>   
  ...
  <tr>
      ...
      <td><input  type="text" id="desconto" name ="desconto" value="<%=pedidoSaida.getVlDesc()%>" onblur="recarregar()" ></td>
  ...
  <tr>
      ...
      <td><input  type="text" id="valorTotal" name ="valorTotal" value="<%=Utilitaria.formatarNumero(valorTotal,2)%>" onkeyup="FormataValor(this,event)" onblur="recarregarDesconto()"></td>
