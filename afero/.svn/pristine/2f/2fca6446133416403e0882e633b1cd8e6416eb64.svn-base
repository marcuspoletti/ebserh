...
%>
    <tr>
      ...
      <td class = "grid" width="30%"><center><a  href="formPedido.jsp?cdEntidade=<%=cdEntidade%>&acao=<%=acao%>&dsEntidade=<%=nomeEntidade%>&idLoja=<%=idLoja%>&idEntrega=<%=idEntrega%>&idColaborador=<%=idColaborador%>&idOrdemServico=<%=idOrdemServico%>"><%=nomeEntidade%></a></center></td>
