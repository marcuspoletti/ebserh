...
if (dataFim == null) {
    ...
    clausula = clausula+" AND ps.idLoja = "+Integer.parseInt(idLojaUsuario);
    clausula = clausula+" AND psi.idProduto = "+Integer.parseInt(idProduto);
...
%>
<h1 class="cabecalho_pagina">Saídas do Estoque</h1>
