...
<script type="text/javascript">
	...
	function processar() {
		...
		loadXMLDoc(
				"formGerarArquivoProdutoProcessar.jsp?arquivo=" + arquivo,
				function() {
...
<body onload="document.forms[0].elements[2].focus();">
	...
	<form name="formGerarArquivoProduto"
		action="formGerarArquivoProduto.jsp" method="post">
		<h1 class="cabecalho">Gerar Arquivo Produto</h1>
			...
			<tr>
				...
				<td><input class="button"
					type="button" value="Processar" onclick="javascript:processar();" />
 					<input class="button" type="button" value="Voltar" onclick="location.href='../cadastros/listarProduto.jsp';" />
				</td>
			</tr>
		</table>
		<div id="retorno"></div>
