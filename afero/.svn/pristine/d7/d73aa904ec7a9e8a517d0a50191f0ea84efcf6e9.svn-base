...
<table border="0" width="100%">
	...
	<tr>
		...
		<td><input type="text"  id="vlUni" name="vlUni" value="<%=Utilitaria.formatarNumero(Float.parseFloat(vlUni), 2).toString() %>" onkeyup="FormataValor(this,event)" onblur="calcula();" size="40" maxlength="40" /></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="text" id="valor" name="valor" value="<%=Utilitaria.formatarNumero(Float.parseFloat(valor), 2).toString() %>"  onkeyup="FormataValor(this,event)"  onblur="calcula();" size="40" maxlength="40"></td>
	</tr>
	<tr>
