...
<table border="0" width="100%">
	<tr>
		...
		<th class="grid">Rel. Ordem Serv.</th>
		<th class="grid">Rel. Ordem Serv. Prod.</th>
...
for ( Iterator<OrdemServico> it = list.iterator(); it.hasNext(); ) {
	...
	<tr>
		...
		<td class="grid" width="5%"><center><a target="_blank" href="impOrdemServico.jsp?acao=atu&idOrdemServico=<%=ordemServico.getIdOrdemServico() %>" ><img border = "0" src="../images/imprimir.gif"></a></center></td>
		<td class="grid" width="8%"><center><a target="_blank" href="../servlet/OrdemServicoServlet?idOrdemServico=<%=ordemServico.getIdOrdemServico() %>&idLoja=<%=ordemServico.getIdLoja() %>&idCliente=<%=entidade.getCdEntidade()%>" ><img border = "0" src="../images/pdf.gif"></a></center></td>
		<td class="grid" width="8%"><center><a target="_blank" href="../servlet/OrdemServicoProdutoServlet?idOrdemServico=<%=ordemServico.getIdOrdemServico() %>&idLoja=<%=ordemServico.getIdLoja() %>&idCliente=<%=entidade.getCdEntidade()%>" ><img border = "0" src="../images/pdf.gif"></a></center></td>
