...
function recarregar() {
  document.forms[0].action='painelItensPedidoAglutinadosSemDivisao.jsp';
  document.forms[0].submit();
}
</script>
<%
...
<div class="cabecalho_pagina">Painel de Pedidos Aglutinados (Sem Divisão)</div>
<hr>
<form action="painelItensPedidoAglutinadosSemDivisao.jsp">
...
<tr>
 <th class="grid" colspan="2">Itens de Pedidos Aglutinados (Sem Divisão)</th>
</tr>
<tr>
 <td colspan="2">
  <iframe src="frameItensPedidoAglutinadosSemDivisao.jsp<%=frameItensPedido%>" src2="" name="frame_pedido" width="100%" height=900 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
</table>
<br><br>
