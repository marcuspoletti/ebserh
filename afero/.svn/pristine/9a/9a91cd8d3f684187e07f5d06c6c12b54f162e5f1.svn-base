...
function recarregar() {
  document.forms[0].action='painelGrupoVendas.jsp';
  document.forms[0].submit();
}
...
<div class="cabecalho_pagina">Painel de Vendas por Grupo</div>
<hr>
<form action="painelGrupoVendas.jsp">
...
<tr>
 <td colspan="2">
  <iframe src="frameVendasGrupos.jsp<%=frame%>" src2="" name="frame_pedido" width="100%" height=200 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
<tr>
...
<tr>
 <td colspan="2">
  <iframe src="frameVendasGrupoCondicaoPagamento.jsp<%=frame%>" src2="" name="frameCondPagto" width="100%" height=200 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
</table>
<br><br>
