...
if (cdLoja == null) {
  ...
  String framePendente = "?dataIni="+dataIni+"&dataFim="+dataFim+"&status=P&idLoja="+idLoja+"&tipoPedido="+tipoPedido+"&statusPag="+statusPag+"&cdCondPagto="+Integer.parseInt(cdCondPagto);
  String frameAtendido = "?dataIni="+dataIni+"&dataFim="+dataFim+"&status=A&idLoja="+idLoja+"&tipoPedido="+tipoPedido+"&statusPag="+statusPag+"&cdCondPagto="+Integer.parseInt(cdCondPagto);
  String frameCancelado = "?dataIni="+dataIni+"&dataFim="+dataFim+"&status=C&idLoja="+idLoja+"&tipoPedido="+tipoPedido+"&statusPag="+statusPag+"&cdCondPagto="+Integer.parseInt(cdCondPagto);
  String continua = "";
%>
<%-- Início do Conteúdo da Página --%>
<div class="cabecalho_pagina">Painel de Pedido Pizzarias</div>
<hr>
<form action="painelPizzaria.jsp">
...
<tr>
 <td colspan="2">
  <iframe src="framePedidoPizzaria.jsp<%= framePendente %>" src2="" name="frame_pedido" width="100%" height=200 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
<tr>
...
<tr>
 <td colspan="2">
  <iframe src="framePedidoPizzaria.jsp<%= frameAtendido %>" src2="" name="frame_pedido" width="100%" height=200 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
<tr>
...
<tr>
 <td colspan="2">
  <iframe src="framePedidoPizzaria.jsp<%= frameCancelado %>" src2="" name="frame_pedido" width="100%" height=200 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
</table>
<br><br>
