...
<div class="cabecalho_pagina">Painel de Pedido Rápido</div>
<hr>
<form action="painelPedidoRapido.jsp">
...
<tr>
 <td colspan="2">
  <iframe src="framePedidoRapido.jsp<%= framePendente %>" src2="" name="frame_pedido" width="100%" height=200 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
<tr>
...
<tr>
 <td colspan="2">
  <iframe src="framePedidoRapido.jsp<%= frameAtendido %>" src2="" name="frame_pedido" width="100%" height=200 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
<tr>
...
<tr>
 <td colspan="2">
  <iframe src="framePedidoRapido.jsp<%= frameCancelado %>" src2="" name="frame_pedido" width="100%" height=200 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
</table>
<br><br>
