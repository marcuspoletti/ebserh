...
//-----------------PEDIDO PRESENCIAL
tipoPedido = "P";
clausula = " WHERE ps.status = '"+status+"' AND ps.tipoPedido = 'P'";
clausula = clausula + " AND ps.dtEntrega BETWEEN '"+converte.DMYToYMDI(dataIniEnt)+" 00:00:00' AND '"+converte.DMYToYMDI(dataFimEnt)+" 23:59:59'";    
...
//---------------------PEDIDO RAPIDO
tipoPedido = "R";
clausula = " WHERE ps.status = '"+status+"' AND ps.tipoPedido = 'R'";
clausula = clausula + " AND ps.dtEntrega BETWEEN '"+converte.DMYToYMDI(dataIniEnt)+" 00:00:00' AND '"+converte.DMYToYMDI(dataFimEnt)+" 23:59:59'";
...
//-----------------PEDIDO TELEFONISTA
tipoPedido = "T";
clausula = " WHERE ps.status = '"+status+"' AND ps.tipoPedido = 'T'";
clausula = clausula + " AND ps.dtEntrega BETWEEN '"+converte.DMYToYMDI(dataIniEnt)+" 00:00:00' AND '"+converte.DMYToYMDI(dataFimEnt)+" 23:59:59'";
