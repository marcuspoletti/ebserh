...
clausula = " WHERE ps.tipoPedido in ('PM') AND ps.status='A' AND ps.tipoPedido is not null AND ps.dtPed BETWEEN '"+converte.DMYToYMDI(dataIni)+" "+horaIni+"' AND '"+converte.DMYToYMDI(dataFim)+" "+horaFim+"'"; 
