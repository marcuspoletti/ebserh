...
<script>
	...
	function recarregar(acao) {
		document.forms[0].action = 'formDuplicataParcelaRecebimento.jsp?acao=' + acao;
		document.forms[0].submit();
	}

	function cancelar() {
		document.forms[0].action = 'formDuplicataParcelaRecebimento.jsp';
		document.forms[0].submit();
	}

	function voltar() {
		document.forms[0].action = 'listarDuplicataReceber.jsp?acao=voltar'
		document.forms[0].submit();
	}
...
<%
	...
	status = "Q";
%>
<body onload="document.all.idConta.focus();">
	<h1 class="cabecalho_pagina">Contas a Receber - Lançar Recebimento em Conta</h1>
	<form method="post" action="listarDuplicataReceber.jsp?acao=<%=acao%>">
		...
		<table border="0" width="100%">
          ...
          <script>comboSelect(document.forms[0].idPlanoConta, '<%= idPlanoConta %>');</script>
			...
			<tr>
				...
				<td><textarea disabled name="historico" cols="50" rows="4"><%=historico%></textarea>
				</td>
          ...
          <script>comboSelect(document.forms[0].idCentroCusto, '<%= idCentroCusto%>');</script>
			...
			<tr>
				...
				<td><input disabled type="text" name="dtEmissao" size="15"
			...
			<tr>
				...
				<td><input disabled type="text" name="dtComp" size="15"
			...
			<tr>
				...
				<td><input disabled type="text" name="nrDoc" <%if (nrDoc != null) {%>
			...
			<tr>
				...
				<td><input disabled type="text" name="dtVenc" size="15"
			...
			<tr>
				...
				<td><input disabled type="text" name="valor" 
			...
			<tr>
				...
				<td class="label_radio">
					<input type="radio" class="radio" name="status" value="A" disabled
					<%=(status.equals("A") ? "checked" : "")%>>A Receber 
					<input type="radio" class="radio" name="status" value="Q"
					<%=(status.equals("Q") ? "checked" : "")%>>Quitado 
					<input type="radio" class="radio" name="status" value="C" disabled 
...
<tr>
	<td>
		<input class="button" type="button" value="Lançar Recebimento" onClick="javascript: salvar();" />
