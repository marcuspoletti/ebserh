...
if (cdEntidade == null)cdEntidade="19506"; 
...
<%--
  ...
  <%--
    <tr>
     ...
     <td>
	               	<input type="text" disabled="disabled" name="dtEntrega" size="15" value="<%= dtEntrega %>" onblur="chkData(this,'dd/MM/yyyy')" maxlength="10" class="inputs">
