...
<tr>
 <td><%@include file="../WEB-INF/jspf/grids/itensPedidoSubItens.jspf"%>
 </td>
 </tr>
 <tr>
...
<tr>
 <td>
  <iframe src="itensPedidoItemSubItens.jsp?idPedidoSaidaItem=<%=idPedidoSaidaItem%>" src2="" name="itensPedido" width="100%" height=300 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
 </tr>
</table>
