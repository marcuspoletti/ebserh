...
%> 
  ...
  <tr>
      ...
      <td><input type="text" id="valorTotal" value="<%=Utilitaria.formatarNumero(valorTotal + valorEntrega ,2)%>" ></td>
  </tr>
  <br>
</table>
<br>
...
<tr>
	...
	<input class="button" type="button" value="Imprimir" onClick="javaScript:void(window.open('impressaoBobina.jsp?idPedidoSaida=<%=idPedidoSaida%>','endeavour','width=420,height=420,scrollbars=yes'));"/></td>
</tr>
</table>
</form>
