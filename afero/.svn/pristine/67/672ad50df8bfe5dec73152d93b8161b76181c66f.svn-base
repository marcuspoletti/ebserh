...
function redirecionar(id) {
  document.forms[0].action='exibirPedidoSaida.jsp?idPedidoSaida='+id;
  document.forms[0].submit();
...
<tr>
 <td><%@include file="../WEB-INF/jspf/grids/itensPedidoSaida.jspf"%>
 </td>
 </tr>
 <tr>
...
<tr>
 <td>
  <iframe src="itensPedidoItemSaida.jsp?idPedidoSaida=<%=idPedidoSaida%>" src2="" name="itensPedido" width="100%" height=300 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
 </tr>
</table>
