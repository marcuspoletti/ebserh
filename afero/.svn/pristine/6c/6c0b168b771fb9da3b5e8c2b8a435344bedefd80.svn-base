...
function recarregar() {
  document.forms[0].action='painelMotoristaEntregador.jsp';
  document.forms[0].submit();
}
</script>
<%
...
if (cdLoja == null) {
  ...
  String framePendente = "?dataIni="+dataIni+"&dataFim="+dataFim+"&status=P&idLoja="+idLoja+"&idMotorista="+idMotorista+"&idEntregador="+idEntregador;
  String frameAtendido = "?dataIni="+dataIni+"&dataFim="+dataFim+"&status=A&idLoja="+idLoja+"&idMotorista="+idMotorista+"&idEntregador="+idEntregador;
  String frameCancelado = "?dataIni="+dataIni+"&dataFim="+dataFim+"&status=C&idLoja="+idLoja+"&idMotorista="+idMotorista+"&idEntregador="+idEntregador;
  String frameFaturado = "?dataIni="+dataIni+"&dataFim="+dataFim+"&status=F&idLoja="+idLoja+"&idMotorista="+idMotorista+"&idEntregador="+idEntregador;
  String continua = "";
%>
<script>
function atualizar() {
...
<div class="cabecalho_pagina">Painel de Motorista/Entregador</div>
<hr>
<form action="painelMotoristaEntregador.jsp">
...
<table border="0" width="100%">
	...
	<input type="text"  name="dataFim" size="15" value="<%= dataFim %>" maxlength="10" onblur="chkData(this,'dd/MM/yyyy')" class="inputs"><a href="javascript:void(0)" onclick="if(self.gfPop)gfPop.fPopCalendar(document.forms[0].dataFim);return false;" HIDEFOCUS><img class="PopcalTrigger" align="absmiddle" src="../js/calendar/calbtn.gif" width="34" height="22" border="0" alt=""></a>
       ...
       <td class='grid'>Motorista<select name="idMotorista">
	 <option value='0'>Selecione...</option>
	<%@include file="../WEB-INF/jspf/combo/comboMotorista.jspf" %></select>
	<script>comboSelect(document.forms[0].idMotorista, idMotorista);</script>
      </td>
       <td class='grid'>Entregador<select name="idEntregador">
	 <option value='0'>Selecione...</option>
	<%@include file="../WEB-INF/jspf/combo/comboEntregador.jspf" %></select>
	<script>comboSelect(document.forms[0].idEntregador, idEntregador)</script>
      </td>
...
<tr>
 <td colspan="2">
  <iframe src="frameMotoristaEntregador.jsp<%= framePendente %>" src2="" name="frame_pedido" width="100%" height=200 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
<tr>
...
<tr>
 <td colspan="2">
  <iframe src="frameMotoristaEntregador.jsp<%=frameAtendido%>" src2="" name="frame_pedido" width="100%" height=200 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
<tr>
...
<tr>
 <td colspan="2">
  <iframe src="frameMotoristaEntregador.jsp<%=frameCancelado%>" src2="" name="frame_pedido" width="100%" height=200 scrolling="auto" align="top" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0"></iframe>
 </td>
</tr>
</table>
<br><br>
