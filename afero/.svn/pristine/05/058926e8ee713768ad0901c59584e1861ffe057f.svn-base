...
<body>
<%
  String usuarioVend = (String)session.getAttribute("Login");
  String ultimoAcesso = "";
%>
<table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	...
	<tr height="18">
		<th bgcolor="#000000" colspan="2" align="right" style="line-height: normal; color: #FFFFFF; font-style: normal; font-size: 9px; font-family: Verdana, Arial, Sans-Serif">&nbsp;<%="Usuário: "+usuarioVend%>&nbsp;-&nbsp;<%="Último acesso: "+ultimoAcesso%>&nbsp;</th>
	</tr>
	<tr>
