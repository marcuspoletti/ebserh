...
<table border="0" width="100%">
    <tr>
      ...
      <th class="grid"><center>End.</center></th>
      <th class="grid"><center>Tel.</center></th>
...
%>
    <tr>
      ...
      <td class = "grid" width="5%"><center><a href="formPedido.jsp?cdCondPagto=<%=cdCondPagto%>&cdEntidade=<%=cdEntidade%>&acao=<%=acao%>&dsEntidade=<%=nomeEntidade%>&idLoja=<%=idLoja%>&idEntrega=<%=1%>&idColaborador=<%=idColaborador%>&referencia=<%=referencia%>&idMesa=<%=idMesa%>"><%=nomeEntidade%></a></center></td>
      <%--<td class = "grid" width="10%"><center><%=cpfCnpj%></center></td> --%>
      <td class = "grid" width="4%"><center><%=endereco +" Bairro: "+bairro + " Cep:"+cep%></center></td>
      <%-- <td class = "grid" width="15%"><center><%=tel%></center></td> --%>
      <td class = "grid" width="2%"><center><%=tel%></center></td> 
...
<%  if (rowNum != 0 || hasNext) { %>
        <right>
<%      if (rowNum != 0) { %>
<a class="link" href="consultarClientes.jsp?rowNum=<%=0%>&idMesa=<%=idMesa%>&cdCondPagto=<%=cdCondPagto %>&idColaborador=<%=idColaborador %>&idEntrega=<%=idEntrega %>&idLoja=<%=idLoja %>&idPedidoSaida=<%=idPedidoSaida %>&nomeLocalizar=<%=nomeLocalizar%>&statusLocalizar=<%=statusLocalizar%>&tpInsc=<%=tpInsc%>&cpfLocalizar=<%=cpfLocalizar%>&telefone=<%=telefone%>&dsEndereco=<%=dsEndereco%>&cdTipoLogradouro=<%=cdTipoLogradouro%>">Primeira</a>&nbsp&nbsp
|&nbsp&nbsp<a class="link" href="consultarClientes.jsp?rowNum=<%=rowNum-gridSize%>&idMesa=<%=idMesa%>&cdCondPagto=<%=cdCondPagto %>&idColaborador=<%=idColaborador %>&idEntrega=<%=idEntrega %>&idLoja=<%=idLoja %>&idPedidoSaida=<%=idPedidoSaida %>&nomeLocalizar=<%=nomeLocalizar%>&statusLocalizar=<%=statusLocalizar%>&tpInsc=<%=tpInsc%>&cpfLocalizar=<%=cpfLocalizar%>&telefone=<%=telefone%>&dsEndereco=<%=dsEndereco%>&cdTipoLogradouro=<%=cdTipoLogradouro%>">< Anterior</a>&nbsp&nbsp
<%      } else { %>
Primeira&nbsp&nbsp|&nbsp&nbsp< Anterior&nbsp
<%      } %>
<%      if (hasNext) { %>
|&nbsp&nbsp<a class="link" href="consultarClientes.jsp?rowNum=<%=rowNum+gridSize%>&idMesa=<%=idMesa%>&cdCondPagto=<%=cdCondPagto %>&idColaborador=<%=idColaborador %>&idEntrega=<%=idEntrega %>&idLoja=<%=idLoja %>&idPedidoSaida=<%=idPedidoSaida %>&nomeLocalizar=<%=nomeLocalizar%>&statusLocalizar=<%=statusLocalizar%>&tpInsc=<%=tpInsc%>&cpfLocalizar=<%=cpfLocalizar%>&telefone=<%=telefone%>&dsEndereco=<%=dsEndereco%>&cdTipoLogradouro=<%=cdTipoLogradouro%>">Próxima ></a>&nbsp&nbsp
|&nbsp&nbsp<a class="link" href="consultarClientes.jsp?rowNum=<%=rowCount-gridSize%>&idMesa=<%=idMesa%>&cdCondPagto=<%=cdCondPagto %>&idColaborador=<%=idColaborador %>&idEntrega=<%=idEntrega %>&idLoja=<%=idLoja %>&idPedidoSaida=<%=idPedidoSaida %>&nomeLocalizar=<%=nomeLocalizar%>&statusLocalizar=<%=statusLocalizar%>&tpInsc=<%=tpInsc%>&cpfLocalizar=<%=cpfLocalizar%>&telefone=<%=telefone%>&dsEndereco=<%=dsEndereco%>&cdTipoLogradouro=<%=cdTipoLogradouro%>">Última</a>
<%      } else { %>
