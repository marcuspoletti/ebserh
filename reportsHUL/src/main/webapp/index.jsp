...
<%@include file="perfil.jsp"%>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <ol class="breadcrumb">
        <li><a href="index.jsp"><i class="fa fa-dashboard"></i>HUL-UFS</a></li>
...
<br>
    ...
    <section class="content">
      <div class="container logo text-center col-sm-12">
        <img src="assets/imagens/LOGO-HUL-HORIZONTAL" alt="logo HUL" />
      </div>
<br>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2025 <a href="index.jsp">HUL-UFS</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
